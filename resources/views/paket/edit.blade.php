    ...
    <div class="col-lg-12">
        <form action="/paket/{{$data_paket->id}}/update"  method="POST">
            ...
            <div class="form-group{{$errors->has('progres_keu') ? 'has-error' : ''}}">
                ...
                <input name="progres_keu" type="number" step="0.01" class="form-control" id="progres_keu" placeholder="Progres Keuangan" value="{{$data_paket7->progres_keu}}">
            ...
            <div class="form-group{{$errors->has('progres_fisik') ? 'has-error' : ''}}">
                ...
                <input name="progres_fisik" type="number" step="0.01" class="form-control" id="progres_fisik" placeholder="Progres Fisik" value="{{$data_paket7->progres_fisik}}">
